...
namespace GAM.Models.Repository
{
    ...
    public class EtapasBitacoraRepositorio
    {
        ...
        /// <param name="id"></param>
        /// <returns></returns>
        protected List<EtapasBitacora> SeleccionarPorIdOportunidad(string id)
        {
        ...
        protected List<Modelos> SeleccionarResponsablesHanLeido(string IdOportunidad)
        {
        ...
        protected List<Modelos> SeleccionarResponsablesEnProceso(string IdOportunidad)
        {
        ...
        protected List<Modelos> SeleccionarResponsablesTerminado(string IdOportunidad)
        {
            b.ExecuteCommandQuery("SELECT " +
            "con.Nombre + ' ' + con.ApellidoPaterno + ' ' + con.ApellidoMaterno AS Contacto, " +
            "CASE " +
        ...
        /// <returns></returns>
        protected string SeleccionarResponsablesPorOportunidad(string IdOportunidad)
        {
