...
namespace GAM.Models.Repository
{
    ...
    public class TareasRepositorio
    {
        ...
        protected List<TareasUsuarios> Buscar(string asunto, string responsable, string inicio, string fin)
        {
        ...
        protected TareasUsuarios SeleccionarPorId(string id)
        {
        ...
        protected int Agregar(Tareas items)
        {
            ...
            b.AddParameter("@inicio", Utilerias.Funciones.PrepararFechaParaAgregar(items.Inicio), SqlDbType.Date);
            b.AddParameter("@fin", Utilerias.Funciones.PrepararFechaParaAgregar(items.Fin), SqlDbType.Date);
        ...
        protected bool Modificar(Tareas items)
        {
