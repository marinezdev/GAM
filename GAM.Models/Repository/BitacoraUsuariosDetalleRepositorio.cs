...
namespace GAM.Models.Repository
{
    ...
    public class BitacoraUsuariosDetalleRepositorio
    {
        ...
        protected int ValidarSiRegistroEsDelUsuario(string id, string idusuario)
        {
            string consulta = "SELECT 1 FROM bitacorausuariosdetalle WHERE id=@id AND idusuario=@idusuario";
            b.ExecuteCommandQuery(consulta);
            b.AddParameter("@id", id, SqlDbType.Int);
            b.AddParameter("@idusuario", idusuario, SqlDbType.Int);
            return int.Parse(b.SelectString());
        ...
        protected int Eliminar(string idusuario)
        {
            b.ExecuteCommandQuery("DELETE FROM bitacorausuariosdetalle WHERE idusuario=@idusuario");
            b.AddParameter("@idusuario", idusuario, SqlDbType.Int);
            return b.InsertUpdateDelete();
        }
    }
