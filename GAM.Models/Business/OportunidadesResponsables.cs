...
namespace GAM.Models.Business
{
    public class OportunidadesResponsables : Repository.OportunidadesResponsablesRepositorio
    {
        ...
        public List<mod.UsuariosEmpresasOportunidadesDetalle> Seleccionar_ResponsablesPorOportunidadPorRol(string id, string idconfiguracion, string idrol)
        {
            return SeleccionarResponsablesPorOportunidadPorRol(id, idconfiguracion, idrol);
        }
