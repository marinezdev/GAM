    ...
    public class HomeController : BaseController
    {
        ...
        public ActionResult Login(string Clave, string Contraseña, string rememberme)
        {
            if (n.usuarios.Validar_ClaveContraseña(Clave, Contraseña) > 0)
            {
                ...
                if (usuariorolsesion.Roles.Id == 1) //Administrador
                {
        ...
        [HttpGet]
        public ActionResult ProyectosAsae(string ed)
        {
            if (ed == "1")
            {
                ViewBag.Titulo = "Proyectos e Importes Acumulados en Proceso";
                ViewBag.Proyectos = n.udn.Seleccionar_ProyectosImportesAcumuladoPorEstado(ed);
            }
            else if (ed == "2")
            {
                ViewBag.Titulo = "Proyectos e Importes En El Mes en Proceso";
                ViewBag.Proyectos = n.udn.Seleccionar_ProyectosImportesEnElMesPorEstado(ed);
            }
            else if (ed == "3")
            {
                ViewBag.Titulo = "Proyectos e Importes Acumulados Cerrados Ganados";
                ViewBag.Proyectos = n.udn.Seleccionar_ProyectosImportesAcumuladoPorEstado("4");
            }
            else if (ed == "4")
            {
                ViewBag.Titulo = "Proyectos e Importes En El Mes Cerrados Ganados";
                ViewBag.Proyectos = n.udn.Seleccionar_ProyectosImportesEnElMesPorEstado("4");
            }
            else if (ed == "5")
            {
                ViewBag.Titulo = "Proyectos e Importes Acumulados Cerrados Perdidos";
                ViewBag.Proyectos = n.udn.Seleccionar_ProyectosImportesAcumuladoPorEstado("3");
            }
            else if (ed == "6")
            {
                ViewBag.Titulo = "Proyectos e Importes En El Mes Cerrados Perdidos";
                ViewBag.Proyectos = n.udn.Seleccionar_ProyectosImportesEnElMesPorEstado("3");
            }
        ...
        {
            ViewBag.BusquedaGeneral = n.busqueda.Seleccionar_Busqueda(busqueda);
            ViewBag.Empresas = n.busqueda.Seleccionar_Busqueda2(busqueda);
            ViewBag.Proveedores = n.busqueda.Seleccionar_Busqueda3(busqueda);
            ViewBag.Buscado = busqueda;
            return View();
        }

        public ActionResult Buscar(string busqueda)
        {
            ViewBag.BusquedaGeneral = n.buscar.Seleccionar_Busqueda(busqueda);
            return View();
        }
        ...
        {
            return Json(n.udn.Seleccionar_ProyectosAcumuladosAlMesPorUDN(), JsonRequestBehavior.AllowGet);
        }
