...
namespace GAM.Controllers
{
    public class DocumentosASAEController : Utilerias.Comun
    {
        ...
        //COnteo de datos para viewbag.subclas
        ...
        public JsonResult SeleccionarSubclasificacionesPorClasificacionP(string idclasificacion)
        {
            List<Subclasificacion> sc = new List<Subclasificacion>();
            if (int.Parse(idclasificacion) > 0)
                sc = n.documentosasaesubclasificaciones.Seleccionar_SubClasificacionesPorClasificacionP(idclasificacion);
            else
                sc = null;
            return Json(sc, JsonRequestBehavior.AllowGet);
        }
